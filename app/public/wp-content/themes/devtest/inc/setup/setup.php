...
function setup() {
	 ...
	 * references of wd_s
	 */
	load_theme_textdomain( 'devtest', get_template_directory() . '/build/languages' );
	...
	register_nav_menus(
		[
			'primary' => esc_html__( 'Primary Menu', 'devtest' ),
			'footer'  => esc_html__( 'Footer Menu', 'devtest' ),
			'mobile'  => esc_html__( 'Mobile Menu', 'devtest' ),
		]
	);
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'devtest_custom_background_args',
			[
	...
	add_theme_support(
		...
		[
			[
				'name' => __( 'Small', 'devtest' ),
				'size' => 12,
				'slug' => 'small',
			],
			[
				'name' => __( 'Normal', 'devtest' ),
				'size' => 16,
				'slug' => 'normal',
			],
			[
				'name' => __( 'Large', 'devtest' ),
				'size' => 36,
				'slug' => 'large',
			],
			[
				'name' => __( 'Huge', 'devtest' ),
				'size' => 50,
				'slug' => 'huge',
			],
		]
