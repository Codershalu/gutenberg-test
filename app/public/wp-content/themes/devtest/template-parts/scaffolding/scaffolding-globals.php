...
use function devtest\devtest\print_global_scaffolding_section;

?>

<section class="section-scaffolding">

	<h2 class="scaffolding-heading" id="<?php esc_html_e( 'globals', 'devtest' ); ?>"><?php esc_html_e( 'Globals', 'devtest' ); ?></h2>
